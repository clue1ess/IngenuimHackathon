const Images = [
    {img : require('../components/DoctorDetails/img/dr_apurva.png')},
    {img : require('../components/DoctorDetails/img/dr_david.png')},
    {img : require('../components/DoctorDetails/img/dr_aniruddha.png')},
    {img : require('../components/DoctorDetails/img/dr_riddhima.png')},
    {img : require('../components/DoctorDetails/img/dr_Maya.png')},
    {img : require('../components/DoctorDetails/img/dr_david.png')}
  ];
